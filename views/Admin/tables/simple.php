...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2" id="menu-m">
        ...
        >
          ...
          <li class="nav-item">
            <a href="../calendar.html" id="menu-m" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../search/enhanced.html" class="nav-link" id="menu-m">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Meta mensual</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>3.</td>
                      <td>Superación de resistencia</td>
                      <td>
                    ...
                    <tr>
                      <td>4.</td>
                      <td>Aplicativo de desarrollo</td>
                      <td>
                        <div class="progress progress-xs progress-striped active">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tareas de la pagina</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body p-0">
                <table class="table table-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>2.</td>
                      <td>Entrenamientos realizados</td>
                      <td>
                        <div class="progress progress-xs">
                          <div class="progress-bar bg-warning" style="width: 70%"></div>
                        </div>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tareas propuestas por Hunters</h3>
              ...
              <div class="card-body p-0">
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <td>1.</td>
                      <td>REalizar tareas de la pagina</td>
                      <td>
                        <div class="progress progress-xs">
                          <div class="progress-bar progress-bar-danger" style="width: 55%"></div>
                        </div>
                    ...
                    <tr>
                      <td>3.</td>
                      <td>No comer muchas calorias</td>
                      <td>
                        <div class="progress progress-xs progress-striped active">
                          <div class="progress-bar bg-primary" style="width: 30%"></div>
                        </div>
                    ...
                    <tr>
                      <td>4.</td>
                      <td>Practicar 4 horas al dia</td>
                      <td>
                        <div class="progress progress-xs progress-striped active">
                          <div class="progress-bar bg-success" style="width: 90%"></div>
                        </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabla sobrante</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Mejores Deportistas semanales</h3>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Mejores Hunters semanales</h3>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Mejores entrenadores</h3>
              </div>
              <!-- ./card-header -->
              <div class="card-body">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">UpDeport.io</a>.</strong> All rights reserved.
  </footer>
