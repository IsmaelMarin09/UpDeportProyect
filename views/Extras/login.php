...
<body class="hold-transition login-page" id="login" style="background: linear-gradient(#fff, #3f87a6);">
<div class="login-box" style="margin-bottom: 50px;">
  <div class="login-logo">
    <img style="height: 178px;" src="../Assets/img/completo-sin fondo (DORADO) .png" alt="">
    <a href="../../index.html"></a>
  </div>
  <!-- /.login-logo -->
  <div class="card" style="border: 2px solid #9d7832;">
    <div class="card-body login-card-body"style="margin-bottom: 0;">
      <p class="login-box-msg">Inicia sesion para acceder</p>

      <form action="validarSesion.php" method="post">
        <div class="input-group mb-3">
          <input style="border-color: #9d7832;" type="email" class="form-control" placeholder="Email" name="correo">
        ...
        <div class="input-group mb-3">
          <input style="border-color: #9d7832;" type="password" class="form-control" placeholder="Password"  name="clave">
          <div class="input-group-append">
            <div class="input-group-text" style="border-color: #9d7832;">
