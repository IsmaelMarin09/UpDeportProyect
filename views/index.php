            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Up Deport</li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                  ...
                  <a href="#" class="small-box-footer"
                    >Lista <i class="fas fa-arrow-circle-right"></i
                  ></a>
                </div>
              </div>
              <!-- ./col -->
